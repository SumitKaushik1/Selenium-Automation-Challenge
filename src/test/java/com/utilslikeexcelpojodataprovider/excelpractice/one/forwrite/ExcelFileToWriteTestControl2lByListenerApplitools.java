...
public class ExcelFileToWriteTestControl2lByListenerApplitools {
    ...
    public static void main(String args[]) {
        ...
        data.put("6", new Object[]{"justToTestRetryListenerOnFailMethod3Chrome", "to test listener count control on method chrome", "No", "3", "1"});


        data.put("7", new Object[]{"TestName", "TestDescription", "Execute", "Priority", "count"});
        data.put("8", new Object[]{"loginWithCredentialsEdge", "to login edge ", "Yes", "0", "1"});
        data.put("9", new Object[]{"totalMoneySpentCalculationEdge", "to calculate money edge", "Yes", "1", "1"});
        data.put("10", new Object[]{"justToTestListenerMethod1Edge", "to test listener count control on method edge", "Yes", "2", "5"});
        data.put("11", new Object[]{"justToTestListenerMethod2Edge", "to test listener count control on method edge", "No", "3", "1"});
        data.put("12", new Object[]{"justToTestRetryListenerOnFailMethod3Edge", "to test listener count control on method edge", "No", "3", "1"});
