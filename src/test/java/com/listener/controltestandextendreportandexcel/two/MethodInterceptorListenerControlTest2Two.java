...
public class MethodInterceptorListenerControlTest2Two implements IMethodInterceptor {

    @Override
    public List<IMethodInstance> intercept(List<IMethodInstance>methods, ITestContext context) {
        try {
            List<Map<String,String>> list= ExcelTwoDataProviderUtils.getTestDetails();
