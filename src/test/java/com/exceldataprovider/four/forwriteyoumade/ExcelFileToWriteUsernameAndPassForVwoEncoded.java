...
public class ExcelFileToWriteUsernameAndPassForVwoEncoded {
        ...
        public static void main(String args[]) {
           ...
           // data.put("2", new Object[]{"loginCredentialsChrome", "yes", "abcdefghi", "Test@1234", "sumit"});
            data.put("2", new Object[]{"loginCredentialsChrome", "yes", "abcdefghi",Base64.getEncoder().encodeToString( "Test@1234".getBytes()), "sumit"});
           // data.put("3", new Object[]{"loginCredentialsChrome", "yes", "akas@wuuvo.com", "Tes@1234", "sumit"});
            data.put("3", new Object[]{"loginCredentialsChrome", "yes", "akas@wuuvo.com", Base64.getEncoder().encodeToString( "Test@1234".getBytes()), "sumit"});
          //  data.put("4", new Object[]{"loginCredentialsChrome", "yes", "akash@wuuvo.com", "Test@1234", "sumit"});
            data.put("4", new Object[]{"loginCredentialsChrome", "yes", "akash@wuuvo.com", Base64.getEncoder().encodeToString( "Test@1234".getBytes()), "sumit"});
           // data.put("5", new Object[]{"loginCredentialsChrome", "no", "akas@wuuo.com", "Test@1235", "sumit"});
            data.put("5", new Object[]{"loginCredentialsChrome", "no", "akas@wuuo.com",  Base64.getEncoder().encodeToString( "Test@1235".getBytes()), "sumit"});
          ...
          //  data.put("7", new Object[]{"TestName", "Execute", "Username", "Password", "fname"});
            ...
            data.put("7", new Object[]{"loginCredentialsEdge", "yes", "abcdefghi", Base64.getEncoder().encodeToString( "Test@1234".getBytes()), "sumit"});

          //  data.put("8", new Object[]{"loginCredentialsEdge", "yes", "akas@wuuvo.com", "Tes@1234", "sumit"});
            data.put("8", new Object[]{"loginCredentialsEdge", "yes", "akas@wuuvo.com", Base64.getEncoder().encodeToString( "Test@1234".getBytes()), "sumit"});

            //data.put("9", new Object[]{"loginCredentialsEdge", "yes", "akash@wuuvo.com", "Test@1234", "sumit"});
            data.put("9", new Object[]{"loginCredentialsEdge", "yes", "akash@wuuvo.com", Base64.getEncoder().encodeToString( "Test@1234".getBytes()), "sumit"});

            //data.put("10", new Object[]{"loginCredentialsEdge", "no", "akas@wuuo.com", "Test@1235", "sumit"});
            data.put("10", new Object[]{"loginCredentialsEdge", "no", "akas@wuuo.com", Base64.getEncoder().encodeToString( "Test@1235".getBytes()), "sumit"});
            data.put("11", new Object[]{"checkUrlDashboardPageEdge", "yes", "", "", "sumit"});
            ...
            try {
                String excelFilePath = System.getProperty("user.dir") + "/resources/excelfiles/vwousernameandpasswordcontrolencoded.xlsx";
