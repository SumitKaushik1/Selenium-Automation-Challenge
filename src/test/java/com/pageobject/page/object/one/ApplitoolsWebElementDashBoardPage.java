...
public final  class ApplitoolsWebElementDashBoardPage extends BasePageObjectOne {
    ...
    public ApplitoolsWebElementDashBoardPage getCurrentUrl() throws KeyUrlNotFoundException {

        String currentUrl=ThreadLocalWebDriver.getDriver().getCurrentUrl();
        return this;
    }

    public ApplitoolsWebElementDashBoardPage negativeSpanApplitoolsDashbord(CalculateEarnedSpent calculateEarnedSpent) throws KeyUrlNotFoundException {
    ...
    public ApplitoolsWebElementDashBoardPage positiveSpanApplitoolsDashbord(CalculateEarnedSpent calculateEarnedSpent) throws KeyUrlNotFoundException {
