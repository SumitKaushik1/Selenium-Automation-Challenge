...
public class BasePageObjectOneChrome {
    ...
    protected void  sendCredentialsKeys(By usernameApplitools,String stringValueFromPropertyFile,String elementname,ApplitoolsChallengeOneChromeTest applitoolsChallengeOneChromeTest) throws KeyUrlNotFoundException {
    ...
    protected void clickLogin(By buttonApplitools, String elementname , ApplitoolsChallengeOneChromeTest applitoolsChallengeOneChromeTest){
