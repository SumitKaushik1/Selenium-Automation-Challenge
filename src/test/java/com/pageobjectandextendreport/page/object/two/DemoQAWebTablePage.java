package com.pageobjectandextendreport.page.object.two;
...
/*
      ...
      //  actions.sendKeys(Keys.PAGE_DOWN).perform();  // Scrolls down a page
// or
        actions.sendKeys(Keys.ARROW_DOWN).perform(); // Scrolls down a smaller amount
*/

        JavascriptExecutor js = (JavascriptExecutor) demoQAWebsiteChallengeTwoTest.controlGetDriver();
        WebElement submitButton= this.findElement(demoQAWebsiteChallengeTwoTest,submitDetailsButtonDemoQAWebTablePage);
...
/*      //  WebElement button = demoQAWebsiteChallengeTwoTest.controlGetDriver().findElement( submitDetailsButtonDemoQAWebTablePage);
        Actions actionss = new Actions(demoQAWebsiteChallengeTwoTest.controlGetDriver());
