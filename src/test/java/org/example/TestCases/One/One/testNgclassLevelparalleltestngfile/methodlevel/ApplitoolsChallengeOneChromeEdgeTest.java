package org.example.TestCases.One.One.testNgclassLevelparalleltestngfile.methodlevel;

import com.basedriver.bast_test_control.one.methodlevel.ControlChromeEdgeOneBaseTest;
import com.cutomannotation.one.OneFrameworkAnnotation;
import com.pageobjectandextendreport.page.object.one.methodlevel.ApplitoolsWebElementDashBoardPage;
import com.pageobjectandextendreport.page.object.one.methodlevel.ApplitoolsWebElementLoginPage;
...
public final class ApplitoolsChallengeOneChromeEdgeTest extends ControlChromeEdgeOneBaseTest {
    ...
    public void loginWithCredentialsChrome() throws Exception {
      ...
      // first 4mehtod come in one thread
        ...
        this.setUpControlChromeEdge("chrome");//note when you make the instsnce here the driver insteance reamin
...
/*
    ...
    @OneFrameworkAnnotation(author = {"sumit","pritam"},category = {"smoke","regression"})
    @Test(priority = 0,groups = {"edge"})
    public void loginWithCredentialsEdge() throws Exception {


        System.out.println("threadname in login edge :"+Thread.currentThread().getName());

        this.setUpControlChromeEdge("edge");//note when you make the instsnce here the driver insteance reamin
        ...
        applitoolsWebElementLoginPage.
                enterUserNameApplitools(LoginCredentialsJsonFileRead.
                        readJsonFile(URLPropertiesConstants.USERNAME),this).enterPasswordApplitools(LoginCredentialsJsonFileRead.
                        readJsonFile(URLPropertiesConstants.PASSWORD),this).
                clickButtonApplitools(this);
...
*/
        ...
        // for each time test case login credentails test case is run then assertion is checked
        //1. if negative test  case obviously test fail  and if positive test test pass and assertion will pass
        Assertions.assertThat(ThreadLocalWebDriverManager.getDriver().getCurrentUrl())
                .as("string is null")
                .isNotNull()
                .matches("^https:\\/\\/demo\\.applitools\\.com\\/app\\.html$");
        //^https:\/\/demo\.applitools\.com\/app\.html$
...
/*
    ...
    @AfterGroups("chrome")
    void closeAllResourcesChromeEdge(){
    ...
    @AfterGroups("edge")
    void closeAllResourcesChromeEdge1(){
