...
//no one extend it
public final class ThreadLocalWebDriverManager {

    //no object of it //only made in thsi classs only
    private ThreadLocalWebDriverManager(){
...
//)
   // static ThreadLocal<WebDriver> webDriverThreadLocal=ThreadLocal.withInitial(
         //   lambda expresion
              //  System.setProperty("webdriver.gecko.driver", DriverAndFilesPathConstants.fireFoxPath
